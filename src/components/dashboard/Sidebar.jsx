...
const Sidebar = ({ isOpen, setIsOpen }) => {
    ...
    const menuItems = [
        ...
        { id: 'withdraw', label: 'Withdrawal', icon: 'minus', href: '/withdraw' },
    ];
    ...
    const icons = {
        ...
        minus: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />,
        gift: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V6a2 2 0 10-2 2h2zm0 0a2 2 0 012 2v2H10v-2a2 2 0 012-2z" />,
    };
            ...
            <aside className={`fixed inset-y-0 left-0 w-72 border-r backdrop-blur-xl flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 overflow-y-auto scrollbar-hide
                ...
                <div className="p-6 flex flex-col min-h-full">
                    ...
                    <div className="mb-8 p-6 rounded-2xl bg-gradient-to-br from-[#a3e635]/10 to-[#84cc16]/5 border border-[#a3e635]/20">
                        <h2 className="text-2xl font-bold mb-2 text-white">Welcome, {firstName}</h2>
