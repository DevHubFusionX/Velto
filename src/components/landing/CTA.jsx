                    ...
                    <div className="relative rounded-[3rem] overflow-hidden">
                        ...
                        <div className="relative px-6 py-10 sm:px-10 sm:py-14 md:p-20 text-center">
                            ...
                            <p className="text-base sm:text-lg md:text-xl text-[#0a1f0a]/80 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed">
                                Join thousands of investors already earning daily returns. Deposit with crypto and start your first plan in under 2 minutes.
                            </p>

                            {/* CTA Buttons */}
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center mb-8">
                                <button onClick={() => setShowRegister(true)} className="group relative w-full sm:w-auto px-7 sm:px-8 py-3 sm:py-4 rounded-full bg-[#0a1f0a] text-white font-semibold text-base sm:text-lg hover:scale-105 transition-all duration-300 shadow-[0_0_40px_rgba(10,31,10,0.3)] overflow-hidden">
                                ...
                                <a href="#contact" className="w-full sm:w-auto px-7 sm:px-8 py-3 sm:py-4 rounded-full bg-white/20 backdrop-blur-sm text-[#0a1f0a] font-semibold text-base sm:text-lg hover:bg-white/30 transition-all duration-300 border-2 border-[#0a1f0a]/20 hover:border-[#0a1f0a]/40 text-center">
                                    Schedule a Demo
                                </a>
                            </div>
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-xs sm:text-sm text-[#0a1f0a]/70">
                                <div className="flex items-center justify-center gap-2">
                                    ...
                                    <span className="font-medium">Crypto deposits supported</span>
                                </div>
                                <div className="flex items-center justify-center gap-2">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                    <span className="font-medium">Daily payouts, every day</span>
                                </div>
                                <div className="flex items-center justify-center gap-2">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
