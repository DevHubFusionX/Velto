...
const Footer = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#a3e635] to-transparent"></div>
                        ...
                        <div className="flex gap-4 flex-wrap">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.name}
                                    href={social.href}
                                    className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#a3e635] hover:border-[#a3e635] transition-all duration-300 group"
                                    aria-label={social.name}
                                >
                                    <SocialIcon name={social.icon} className="w-5 h-5 text-gray-400 group-hover:text-[#0a1f0a] transition-colors" />
                                </a>
                            ))}
                        </div>
                    </div>
